...
void CircleFit::Fit()
{
	...
	minimizer.SetMaxFunctionCalls((int)1e6);
	minimizer.SetMaxIterations((int)1e5);
	minimizer.SetTolerance(1e-10);
	...
	minimizer.SetVariable(0,"x0",init[0],step[0]);
	minimizer.SetVariable(1,"y0",init[1],step[1]);
	minimizer.SetVariable(2,"r",init[2],step[2]);
